"""
URL configuration for Gestion_quartier_ameliorer project.
...
from .views import Authentification,formulaireAuthentification

urlpatterns = [
    path('', include('administrateur.urls')),
    path('', include('quartier.urls')),
    path('', include('maison.urls')),
    path('', include('categorie.urls')),
